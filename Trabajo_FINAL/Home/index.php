        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          <form class="d-flex align-items-center form-style" role="search">
            <li class="nav-item dropdown list-item">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img class="avatar-style icon" src="/Trabajo_FINAL/unrClient/Imagenes-Videos/avatar.png" alt="">Cliente</a>
