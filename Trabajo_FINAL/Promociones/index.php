    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <div class="navbar-style">
          <a class="navbar-brand" href="#Home"><img class="icon" src="/Trabajo/Trabajo_FINAL/Cliente/Imagenes-Videos/bolsas-de-compra.png" alt="Icono"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          <form class="d-flex align-items-center form-style" role="search">
            <li class="nav-item dropdown list-item">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img class="avatar-style icon" src="/Trabajo/Trabajo_FINAL/Cliente/Imagenes-Videos/avatar.png" alt="">Cliente</a>
            ...
            <img class="icon cerrar-sesion" src="/Trabajo/Trabajo_FINAL/Cliente/Imagenes-Videos/Cerrar-sesion.png" alt="">
            <input class="btn btn-outline-danger btn-delete" value="Cerrar Sesión" type="submit">
    ...
    if (empty($_POST["busqueda"])) {
      ...
      if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
          if ($row["Fecha_Inicio"] <= $fecha_actual && $row["Fecha_Fin"] >= $fecha_actual) {
            echo "
                    <div class='container'>
                          <div class ='local_data'> Local {$row['id']} <br>  {$row['Local']} <br> {$row['Rubro']} </div>
                          <div class = 'div-content base-div'>
                            <p class = 'data'> {$row['Nombre']}</p>
                          </div>
                          <div class = 'div-content hover-div'>
                            <a class='link_promociones' href='Promociones.php'>Usar</a>
                          </div>
                    </div>";
          }
        };
      ...
      $query = "SELECT * FROM promociones WHERE Local = '$busqueda'";
    ...
    <div class="f1">
      ...
      <div class="img_mapa">
        <a href="https://www.google.com/maps/place/Alto+Rosario+Shopping/@-32.9282706,-60.674688,15z/data=!4m6!3m5!1s0x95b654abc3ab1d5f:0x2f90ce97db2c5a6!8m2!3d-32.9274658!4d-60.6690017!16s%2Fg%2F1tdvlb_y?entry=ttu" target="_blank">
          <img src="/Trabajo_FINAL/Cliente/Imagenes-Videos/Captura de pantalla 2024-05-02 100702.png" alt="Ubicación en Google Maps"></a>
      </div>
    </div>
