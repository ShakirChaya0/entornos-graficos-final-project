      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="Promociones.php">Promociones</a>
            </li>
          ...
          if($filas["total_filas"] > 0){
                  ...
                  echo "
                    <div class='container container_usada'>
                      ...
                      <div class = 'div-content base-div'>
                        <p class = 'prom_usada'> {$row_promo['textoPromo']}</p>
                      </div>
            ...
            if($flag){
              echo "
                ...
                <div class = 'div-content base-div'>
                <p class = 'data'> {$row_promo['textoPromo']}</p>
                </div>
                <div class = 'div-content hover-div'>
                ...
                if(!empty($_POST["{$row_promo['codPromo']}"]) && $_POST["{$row_promo['codPromo']}"] == "Usar") {
                  ...
                  $result_addprom = mysqli_query($conn, $add_prom);
                  $_POST = array();
