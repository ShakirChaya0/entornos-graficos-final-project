    ...
    <section>
        ...
        <div class="create_box">
            <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" class="form_create">
                ...
                <input type="text" placeholder="..." class="form-create__input" id="nombre" name="name" required>
                <label class="create_label" for="ubi">Ubicación:</label>
                <input type="text" placeholder="..." class="form-create__input" id="ubi" name="ubi" required>
                <label class="create_label" for="rubro">Rubro:</label>
                <input type="text" placeholder="..." class="form-create__input" id="rubro" name="rubro" required>
                <label class="create_label" for="usuario">Código de Usuario:</label>
                <input type="text" placeholder="..." class="form-create__input" id="usuario" name="user" required>
