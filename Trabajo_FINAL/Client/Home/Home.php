...
<head>
  ...
  <title>Rosario Shopping center - Home</title>
...
<body>
  ...
  <!-- Video de la página principal de clientes (Se puede modularizar) -->
  ...
  <!-- Carrousel de la página principal de clientes (Se puede modularizar) -->
  <div id="locales"></div>
  ...
  <!-- Pie de página de la página principal de clientes (Se puede modularizar) -->
  <?php
