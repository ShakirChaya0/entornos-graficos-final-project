...
<header class="header">
    ...
    ?>
            <div class="navbar-style">
                <a class="navbar-brand" href="../../Client/Home/Home.php"><img class="icon" src="../../Imagenes-Videos/bolsas-de-compra.png" alt="Icono"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link active" aria-current="page" href="../../Client/Home/Home.php#About us">Sobre Nosotros</a>
                  </li>
                  <li class="nav-item">
    ...
    ?>
            <div class="navbar-style">
                <a class="navbar-brand" href="../../Owner/Home/Home.php"><img class="icon" src="../../Imagenes-Videos/bolsas-de-compra.png" alt="Icono"></a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll" aria-controls="navbarScroll" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
            </div>
    ...
    ?>
                <div class="navbar-style">
                  <a class="navbar-brand" href="../../admin/home/home_page_admin.php"><img class="icon" src="../../Imagenes-Videos/bolsas-de-compra.png" alt="Icono"></a>
                  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll" aria-controls="navbarScroll" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                  </button>
                </div>
