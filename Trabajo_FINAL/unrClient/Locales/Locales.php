    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <div class="navbar-style">
          <a class="navbar-brand" href="#Home"><img class="icon" src="/Trabajo/Trabajo_FINAL/unrClient/Imagenes-Videos/bolsas-de-compra.png" alt="Icono"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          <form class="d-flex align-items-center form-style" role="search">
            <li class="nav-item dropdown list-item">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img class="avatar-style icon" src="/Trabajo/Trabajo_FINAL/unrClient/Imagenes-Videos/avatar.png" alt="">Cliente</a>
            ...
            <img class="icon cerrar-sesion" src="/Trabajo/Trabajo_FINAL/unrClient/Imagenes-Videos/Cerrar-sesion.png" alt="">
    ...
    <footer class="footer">
        <div class="f1">
            ...
            <div class="img_mapa">
                ...
                <img src="../../admin/shopping_map.png" alt="Ubicación en Google Maps"></a>
            </div>
        </div>
