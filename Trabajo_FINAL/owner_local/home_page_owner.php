	...
	<header class="header">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="home_page_admin.html"><img class="icon" src="../Imagenes-Videos/bolsas-de-compra.png" alt="Inicio" title="Inicio"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active" aria-current="page" href="#">Solicitudes de Uso</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Reportes de Promociones</a>
                        </li>
                    </ul>
                    <li class="nav-item dropdown list-item">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img class="avatar-style icon" src="../Imagenes-Videos/avatar.png" alt="">Dueño</a>
        ...
        <div class="f2">
            <div class="contact_container">
                ...
                <div class="logo_footer">
                    ...
                    <a href="https://instagram.com" target="_blank">Nuestro Instagram!</a>
                </div>
            </div>
        </div>
